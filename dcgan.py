...
class DCGAN():
    ...
    def train(self, iterations, batch_size=128, save_interval=50, model_interval=1000, check_noise=None, r=10, c=10):
        ...
        for iteration in range(iterations):
            ...
            if iteration % save_interval == 0:
                ...
                if iteration % model_interval == 0:
                    self.generator.save("ganmodels/set_4/dcgan-{}-iter.h5".format(iteration))

    def save_imgs(self, iteration, check_noise, r, c):
        noise = np.random.uniform(-1,1, (10000, 100))
        #noise = check_noise
        gen_imgs = self.generator.predict(noise)
        ...
        for i in range(10000):
            ...
            pil_img.save('images/gen_imgs/gen_road_damage_%d_%d.png' % (iteration, cnt))
...
if __name__ == '__main__':
    ...
    dcgan.train(iterations=50000, batch_size=32, save_interval=10000, model_interval=5000, check_noise=check_noise, r=r,
                c=c)
